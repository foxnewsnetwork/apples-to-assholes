...
(function() {
  var Card, Cards, Game, Player, Players, Room, Rooms, Vote, Votes, apples_to_assholes, methodMap, socket, sync_machine,
    ...
    Card.random = function(options) {
      ...
      switch (options["category"]) {
        case "white":
          ...
          return card["image"] = "http://upload.wikimedia.org/wikipedia/commons/thumb/8/88/46_Dick_Cheney_3x4.jpg/220px-46_Dick_Cheney_3x4.jpg";
        case "black":
          return card["content"] = "Trevor thinks of _____________ every night before going to bed.";
        default:
