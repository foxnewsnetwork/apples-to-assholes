...
(function() {
  var Card, CardView, Cards, Flash, Game, Player, PlayerView, Players, Room, RoomView, Rooms, Timer, Vote, Votes, methodMap, socket, sync_machine,
  ...
  Room = (function(_super) {
    ...
    Room.prototype.initialize = function() {
      ...
      this.view.render();
      Backbone.Events.on("vote:win", function() {
        _this.score += 1;
        return _this.view.update_score();
      });
  ...
  Votes = (function(_super) {
    ...
    Votes.prototype.remove = function() {
      var count;
      count = this.length;
      while (this.length > 0) {
        this.pop().destroy();
  ...
  CardView = (function(_super) {
    ...
    CardView.prototype.interact = function() {
      if (CardView.first_click) {
        ...
        if (this.model.in_play) {
          Backbone.Events.trigger("vote:create", this.model);
        }
  ...
  RoomView = (function(_super) {
    ...
    RoomView.prototype.render = function() {
      this.parent.append("<div class='vote-counter'></div>");
      this.parent.append($(this.el));
      return this.update_score();
    };

    RoomView.prototype.update_score = function() {
      return $(".vote-counter").html(this.model.score);
    };
  ...
  Game = (function(_super) {
    ...
    Game.prototype.room_switch = function(name) {
      return Flash.show("Switched to room " + name, "success");
    };
  ...
  socket.on("backbone event down", function(eventname, data) {
    if (data != null) {
      data = _.extend(data, {
        "local": true
      });
    ...
    return Backbone.Events.trigger("" + eventname, data);
  });
